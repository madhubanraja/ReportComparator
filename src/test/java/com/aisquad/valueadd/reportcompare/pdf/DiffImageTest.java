...
import static com.aisquad.valueadd.reportcompare.pdf.ImageTools.EXCLUDED_BACKGROUND_RGB;
import static com.aisquad.valueadd.reportcompare.pdf.ImageTools.blankImage;
...
public class DiffImageTest {
    ...
    public void equalImagesAreEqualAndEqualPixelsAreDimmed() {
        ...
        MatcherAssert.assertThat(resultImage.getRGB(23, 23), CoreMatchers.is(DiffImage.color(153, 153, 153)));
    }
    ...
    public void unexpectedPixelsAreColoredRed() {
        ...
        MatcherAssert.assertThat(resultImage.getRGB(23, 23), CoreMatchers.is(DiffImage.color(210, 0, 0)));
    ...
    public void expectedPixelsNotPresentAreColoredGreen() {
        expected.setRGB(23, 23, Color.BLACK.getRGB());
        final BufferedImage resultImage = createAndAssertDiffImage(true, false);
        MatcherAssert.assertThat(resultImage.getRGB(23, 23), CoreMatchers.is(DiffImage.color(0, 180, 0)));
    ...
    public void exclusionsAreColoredYellowAndDimmed() {
        ...
        MatcherAssert.assertThat(resultImage.getRGB(36, 36), CoreMatchers.is(DiffImage.color(237, 153, 153)));
    ...
    private void assertMarker(final BufferedImage resultImage, final int x, final int y) {
        for (int i = 0; i < 20; i++) {
            MatcherAssert.assertThat(resultImage.getRGB(x, i), CoreMatchers.is(DiffImage.MARKER_RGB));
            MatcherAssert.assertThat(resultImage.getRGB(i, y), CoreMatchers.is(DiffImage.MARKER_RGB));
        }
    }
}